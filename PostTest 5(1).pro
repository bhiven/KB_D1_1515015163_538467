...
GOAL
  ...
  /*
  	ini adalah sebuah program mencari orang yang ulang tahun pada bulan ini. 
  	pertama mengecek bulan pada tanggal sekarang dan menyimpan di dalam variabel bulan_ini.
  	kedua mengambil data nama orang dan tanggal lahir yang disimpan di variabel orang dan tanggal.
  	ketiga membandingkan nilai variabel tanggal dengan nilai variabel tanggal.
  	keempat konversi nilai bulan ini dengan fakta.
  	menampilkan nama orang pertama dan kedua yang ulang tahun.
